  ...
  public: {
    Tables: {
      ...
      commissions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "commissions_shop_id_fkey"
            columns: ["shop_id"]
            isOneToOne: false
            referencedRelation: "shops"
            referencedColumns: ["id"]
      ...
      delivery_locations: {
        ...
        Relationships: [
          {
            foreignKeyName: "delivery_locations_delivery_partner_id_fkey"
            columns: ["delivery_partner_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      check_delivery_availability: {
        Args: { p_cust_lat: number; p_cust_lng: number; p_shop_id: string }
        Returns: boolean
      }
